...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'emboss-sm': 'var(--shadow-emboss-sm)',
				'emboss': 'var(--shadow-emboss-md)',
				'emboss-lg': 'var(--shadow-emboss-lg)',
				'emboss-xl': 'var(--shadow-emboss-xl)',
			...
			keyframes: {
				...
				'glow': {
					from: { boxShadow: '0 0 20px hsl(38 62% 50% / 0.3)' },
					to:   { boxShadow: '0 0 48px hsl(38 62% 50% / 0.6)' },
				},
				'shimmer': {
